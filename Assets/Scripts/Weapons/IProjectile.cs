...
public interface IProjectile //the interface for all projectiles fired from ranged Weapons
{
    ...
    float Damage { get; set; } //damage of each bullet, determined by the weapon that fires it
    ...
    void SetBulletStatsAndTransform(float gunDamage, Vector3 pos, Quaternion rot);
}
