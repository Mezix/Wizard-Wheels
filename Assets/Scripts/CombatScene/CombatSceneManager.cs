...
public class CombatSceneManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        CopyVehicleDataFromTo(DataStorage.Singleton.playerData.Geometry, ref REF.PCon.TGeo._vehicleData);
        REF.PCon._vehicleInfo = DataStorage.Singleton.playerData.Info;
        REF.PCon.SpawnTank();
    }
