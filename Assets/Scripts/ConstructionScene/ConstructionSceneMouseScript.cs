...
public class ConstructionSceneMouseScript : MonoBehaviour
{
    public Image _mouse;
    ...
    private void TrackMouse()
    {
        ...
        {
            ConstructionSceneManager.instance.mouse._mouse.sprite = Resources.Load(GS.Cursors("CreateTankCursor"), typeof(Sprite)) as Sprite;
            ConstructionSceneManager.instance._tools.previewTile = false;
        }
        else
        {
            if(_mouseState == "Brush")
            {
                ConstructionSceneManager.instance.mouse._mouse.sprite = Resources.Load(GS.Cursors("Brush"), typeof(Sprite)) as Sprite;
                ConstructionSceneManager.instance._tools.previewTile = true;
            }
            if(_mouseState == "Eraser")
            {
                ConstructionSceneManager.instance.mouse._mouse.sprite = Resources.Load(GS.Cursors("Eraser"), typeof(Sprite)) as Sprite;
                ConstructionSceneManager.instance._tools.previewTile = false;
            }
        }
    }
